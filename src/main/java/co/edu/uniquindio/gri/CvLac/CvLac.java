...
public class CvLac {
	 ...
	 * @return
	 */
	public Investigador extraer(String url, String estado, boolean encontrado) {
					...
					for (Element elem : entradas) {
						...
						if (elem.text().startsWith("Jurado en comités de evaluación")) {
							...
							if (auxActEvaluador == null) {
								auxInvestigador
										.setProducciones(extraerJuradoComites(elemJuradoComite, auxInvestigador));
							} else {
						...
						if (elem.text().contains("Par evaluador")
						...
						if (elem.text().startsWith("Ediciones/revisiones")) {
							...
							if (auxApropSocial == null) {
								auxInvestigador
										.setProducciones(extraerEdicionesRevisiones(elemEdicion, auxInvestigador));
							} else {
						...
						if (elem.text().startsWith("Redes de conocimiento especializado")) {
							...
							if (auxApropSocial == null) {
								...
								auxApropSocial
										.addAll(extraerRedesDeConocimiento(elemRedesConocimiento, auxInvestigador));
								auxInvestigador.setProducciones(auxApropSocial);
							}
						}
						...
						if (elem.text().startsWith("Generación de contenido impresa")) {
							...
							if (auxApropSocial == null) {
								auxInvestigador.setProducciones(
										extraerContenidoImpreso(elemContenidoImpreso, auxInvestigador));
							} else {
						...
						if (elem.text().startsWith("Generación de contenido multimedia")) {
							...
							if (auxApropSocial == null) {
								...
								auxApropSocial
										.addAll(extraerContenidoMultimedia(elemContenidoMultimedia, auxInvestigador));
								auxInvestigador.setProducciones(auxApropSocial);
							}
						}
						...
						if (elem.text().startsWith("Generación de contenido virtual")) {
							...
							if (auxApropSocial == null) {
								auxInvestigador.setProducciones(
										extraerContenidoVirtual(elemContenidoVirtual, auxInvestigador));
							} else {
						...
						if (elem.text().startsWith("Estrategias de comunicación del conocimiento")) {
							...
							if (auxApropSocial == null) {
								...
								auxApropSocial.addAll(extraerEstrategiaComunicacionPedagogica(
										elemEstrategiaComunicacion, auxInvestigador));
								auxInvestigador.setProducciones(auxApropSocial);
							}
						}
						...
						if (elem.text().startsWith("Estrategias pedagógicas para el fomento a la CTI")) {
							...
							if (auxApropSocial == null) {
								auxInvestigador.setProducciones(extraerEstrategiaComunicacionPedagogica(
										elemEstrategiaPedagogica, auxInvestigador));
							} else {
								auxApropSocial.addAll(extraerEstrategiaComunicacionPedagogica(elemEstrategiaPedagogica,
										auxInvestigador));
								auxInvestigador.setProducciones(auxApropSocial);
							}
						}
						...
						if (elem.text().startsWith("Participación ciudadana en proyectos de CTI")) {
							...
							List<Produccion> auxApropSocial = auxInvestigador.getProducciones();
							if (auxApropSocial == null) {
								auxInvestigador.setProducciones(extraerParticipacionCiudadanaCTI(
										elemParticipacionCiudadanaCTI, auxInvestigador));
							} else {
								auxApropSocial.addAll(extraerParticipacionCiudadanaCTI(elemParticipacionCiudadanaCTI,
										auxInvestigador));
								auxInvestigador.setProducciones(auxApropSocial);
							}
						}
						...
						if (elem.text().startsWith("Artículos")) {
							...
							if (auxProdBibliografica == null) {
								auxInvestigador.setProduccionesBibliograficas(
										extraerArticulos(elemArticulos, auxInvestigador));
							} else {
						...
						if (elem.text().startsWith("Libros")) {
							...
							if (auxProdBibliografica == null) {
								auxInvestigador
										.setProduccionesBibliograficas(extraerLibros(elemLibros, auxInvestigador));
							} else {
						...
						if (elem.text().startsWith("Capitulos de libro")) {
							...
							if (auxProdBibliografica == null) {
								auxInvestigador.setProduccionesBibliograficas(
										extraerCapLibros(elemCapLibros, auxInvestigador));
							} else {
						...
						if (elem.text().startsWith("Textos en publicaciones no científicas")) {
							...
							if (auxProdBibliografica == null) {
								...
								auxProdBibliografica
										.addAll(extraerPubNoCientificas(elemPubNoCientificas, auxInvestigador));
								auxInvestigador.setProduccionesBibliograficas(auxProdBibliografica);
							}
						}
						...
						if (elem.text().startsWith("Productos tecnológicos")) {
							...
							if (auxProdTecnica == null) {
								auxInvestigador
										.setProducciones(extraerProdTecnica(elemProdTecnologicos, auxInvestigador));
							} else {
						...
						if (elem.text().startsWith("Innovación de proceso o procedimiento")) {
							...
							if (auxProdTecnica == null) {
								auxInvestigador
										.setProducciones(extraerProdTecnica(elemProcesosTecnicas, auxInvestigador));
							} else {
						...
						if (elem.text().startsWith("Trabajos técnicos")) {
							...
							if (auxProdTecnica == null) {
								auxInvestigador
										.setProducciones(extraerProdTecnica(elemTrabajosTecnicos, auxInvestigador));
							} else {
						...
						if (elem.text().startsWith("Empresas de base tecnológica")) {
							...
							if (auxProdTecnica == null) {
								auxInvestigador
										.setProducciones(extraerEmpresas(elemEmpresasTecnologicas, auxInvestigador));
							} else {
						...
						if (elem.text().startsWith("Demás trabajos")) {
							...
							if (auxProduccion == null) {
								auxInvestigador
										.setProducciones(extraerDemasTrabajos(elemDemasTrabajos, auxInvestigador));
							} else {
						...
						if (elem.text().startsWith("Registros de acuerdo de licencia")) {
							...
							if (auxProdArte == null) {
								auxInvestigador.setProducciones(
										extraerRegistrosAcuerdo(elemRegistrosLicencia, auxInvestigador));
							} else {
		...
		if (elemInfoPersonal.size() == 0) {
			...
			try {
				...
				for (int i = 0; i < elemInfoPersonal.size(); i++) {
					...
					try {
						if (elemInfoPersonal.get(i).contains(",") && elemInfoPersonal.get(i + 2).equals("SI")) {
